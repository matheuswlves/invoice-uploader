    ...
    var UploadService = _classThis = class {
        ...
        processFile(file) {
            return __awaiter(this, void 0, void 0, function* () {
                const text = (yield Tesseract.recognize(file.path)).data.text;
                const document = yield this.prisma.document.create({
                    data: { filename: file.originalname, extractedText: text }
                });
                return document;
            });
        }
        askLLM(documentId, question) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a;
                const document = yield this.prisma.document.findUnique({ where: { id: Number(documentId) } });
                if (!document)
                ...
                return { answer: (_a = response.data.choices[0].message) === null || _a === void 0 ? void 0 : _a.content };
            });
        }
    };
